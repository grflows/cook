...
a tiny lua-like langauge transpiled into javascript.
The current version is written in python.
...
these are compile and run-time checkers to prevent some simple but annoying bugs.
Here're some of the most used guards.
